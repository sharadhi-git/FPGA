...
REM
REM Generated by Vivado on Wed Dec 24 15:57:25 +1100 2025
...
echo "xvlog --incr --relax -prj one_to_four_demux_tb_vlog.prj"
call xvlog  --incr --relax -prj one_to_four_demux_tb_vlog.prj -log xvlog.log
